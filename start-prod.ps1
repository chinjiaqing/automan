...
Write-Host "  Automan - Production Setup" -ForegroundColor Yellow
Write-Host "============================================" -ForegroundColor Yellow
Write-Host ""
...
Write-Host ""
Write-Host "============================================" -ForegroundColor Yellow
Write-Host "  Automan - Production Server" -ForegroundColor Yellow
Write-Host "============================================" -ForegroundColor Yellow
Write-Host ""
Write-Host "  Starting server..." -ForegroundColor White
Write-Host ""

# Start server in production mode (tsx, no watch)
$serverDir = Join-Path $ROOT 'server'
$tsxCmd    = Join-Path $serverDir 'node_modules\.bin\tsx.cmd'

$env:NODE_ENV = 'production'
Set-Location $serverDir
& $tsxCmd src\server.ts
